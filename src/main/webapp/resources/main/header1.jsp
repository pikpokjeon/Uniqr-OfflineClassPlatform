...
<body>
    ...
    <nav class="navbar navbar-light bg-white" id="navbar_header1">
        ...
        <a class="navbar-brand" href="/">
            <img id="headlogo"src="/resources/main/img/logo1.png" 
    ...
    <!-- 메뉴카테고리 -->
    <nav class="navbar navbar-light bg-light" id="navbar_header2">
        <div class="header3">
            <div class="header_Category">
                <ul>
                    <li>
                        <svg class="bi bi-card-text" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                        ...
                        <a href="/seller/category?scategory=entexam">입시과외</a>
                    </li>
                    <li>
                        <svg class="bi bi-display-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <a href="/seller/category?scategory=itdev">IT개발</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=design">디자인</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=marketing">마케팅</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=finance">재무회계</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=selfdev">자기계발</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=photo">사진영상</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=lifestyle">라이프스타일</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=health">건강피트니스</a>
                    </li>
                    <li>
                        ...
                        <a href="/seller/category?scategory=music">음악</a>
                    </li>
                    <li>
                        <svg class="bi bi-type" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <a href="/seller/category?scategory=foreignlang">외국어</a>
                    </li>
                    <li>
                        <svg class="bi bi-layers" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                        ...
                        <a href="/seller/category?scategory=scholar">학문</a>
                    </li>
                </ul>
            </div>
        </div>
