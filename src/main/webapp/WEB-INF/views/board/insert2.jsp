    ...
    <div id="boardWrapper">
      ...
      <table id="boardInputTable">
        <tbody>
          ...
          <tr>
            <td>
              <input id="boardInputTitle" name="atitle" class="form-control" type="text" placeholder="{}" readonly="readonly">
            </td>
          </tr>
          ...
          <tr>
            <td>
              <textarea id="boardInputTextarea" class="form-control" id="formTextarea1" name="acontent" rows="10" placeholder="{}" ></textarea>
            </td>
          </tr>
          ...
          <tr>
            <td>
              ...
              <button id="boardSubmit" type="submit" class="btn btn-primary">수정하기</button> 
              </td>
          </tr>
